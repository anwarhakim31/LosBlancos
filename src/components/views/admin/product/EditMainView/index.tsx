...
const EditProductMainView = ({ product }: { product: TypeProduct }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      stock: product.stock || [],
      collectionName: product?.collectionName?.name || "",
  ...
  const [atribut, setAtribut] = useState<TypeAttribute | undefined>({
    name: product?.attribute,
    value: product?.stock?.map((item: TypeStock) => item.value),
  });
...
export default EditProductMainView;
