    ...
    <section className={styles.container}>
      ...
      <div className={styles.wrapper}>
        <div className={styles.wrapper__images}>
          ...
          <div className={styles.wrapper__images__dots}>
            {product.image.map((_, i) => (
              <div
                key={i}
                className={`${styles.wrapper__images__dots__dot} ${
                  selected === i ? styles.wrapper__images__dots__select : ""
                }`}
              ></div>
            ))}
          </div>
        </div>
        <div className={styles.wrapper__info}></div>
      </div>
    </section>
  );
};
